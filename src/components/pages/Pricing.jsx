...
export default () => (
	<Page>
		...
		<p>Since you are on this page, I think it's safe to assume that you like my style and you're considering to hire me.  If you are interested in my rates, I can send you a detailed document of my full package prices to answer all the questions you might have right now.</p> <br /> All you need to do for this is just to send me an email to mail@anniekostolany.com or fill out the contact form below.
		<p>
