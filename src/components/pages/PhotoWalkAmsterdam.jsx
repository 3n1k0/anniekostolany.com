...
export default () => (
	...
	<p> For most European people Amsterdam is the city of freedom. But besides that, it is utterly romantic too. As soon as you walk through the narrow streets and cross the canals on one of the million charming bridges you will immediately know what I mean. 
		It is one of my favourite places on Earth, right next to Haarlem on my list. Haarlem is exactly like a mini-Amsterdam but it's easier to get the perfect photos as there are less tourists there. 
		Leave the selfie stick home and join me for a photo session! Contact me for details and availability. </p>
