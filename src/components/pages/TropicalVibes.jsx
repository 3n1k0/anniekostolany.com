...
export default () => (
	<Page>
		...
		<Helmet>
			<meta name="description" content="You cannot really go wrong with a naturally beautiful model and exotic palm trees." />
			<title>Tropical Vibes | Annie Kostolany</title>

			<meta property="og:title" content="Tropical Vibes | Annie Kostolany" />
			<meta property="og:description" content="You cannot really go wrong with a naturally beautiful model and exotic palm trees." />
			<meta property="og:image" content="https://anniekostolany.com/images/tropical_vibes/palmak.jpg" />
		</Helmet>

		<h2>Tropical Vibes</h2>
		<p>Zsofia is a naturally beautiful model who barely wore any makeup for these photos. She moved and posed like it was the most natural thing for her which I found truly amazing. The tall and graceful palm trees are just the perfect match for her southern features.</p>
