...
export default () => (
	<Page>
		<Helmet>
			<meta name="description" content="Rock'n roll spirit reborn in fashion" />
			<title>Rock'n roll girl | Annie Kostolany</title>

			<meta property="og:title" content="Rock'n roll girl | Annie Kostolany" />
			<meta property="og:description" content="Rock'n roll spirit reborn in fashion" />
			<meta property="og:image" content="https://anniekostolany.com/images/rebellion/korlat.jpg" />
		</Helmet>
