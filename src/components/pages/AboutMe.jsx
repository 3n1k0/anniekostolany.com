...
export default () => (
	<Page title="About me">
		...
		<p>
			...
			shape add up to create a feeling or an impression. <br /> Then I
			transform it into photographs. <br /> I love travelling with my
			camera. I took photos in Germany, Hungary, France, the Netherlands,
			and in the States. No matter where I am, I always absorb as much as
			I can, because foreign cultures and all corners of this world
			fascinate me more than anything.
		</p>

		<p>
			Is it me who you need as a photographer? Let's meet for a coffee and
