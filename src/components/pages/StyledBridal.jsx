...
export default () => (
	<Page>
		<Helmet>
			<meta name="description" content="This photoshoot in Den Bosch was inspired by fairytales and my beautiful model, Celine." />
			<title>Wedding & bridal shoots | Annie Kostolany</title>

			<meta property="og:title" content="Wedding & bridal shoots | Annie Kostolany" />
			<meta property="og:description" content="This photoshoot in Den Bosch was inspired by fairytales and my beautiful model, Celine." />
