...
export default () => (
	<Page>
		<Helmet>
			<meta
				name="description"
				content="This photoshoot in Den Bosch was inspired by fairytales and my beautiful model, Celine."
			/>
		...
		<p>
			...
			magnificent, marvelous, graceful and delicate. The reason I do
			styled bridal shoots is to show my perspective on how I see these
			beautiful occasions.
